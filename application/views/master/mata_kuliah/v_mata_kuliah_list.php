      ...
      <div class="col-lg-12">
        <div class="box box-primary">
          ...
          <tr>
            ...
            <td align="center"><?=$row->nama_matkul?></td>
            <td align="center"><?=$row->sks_matkul?></td>
            ...
            <?php
              ...
              ?>
              <a href="<?= site_url('master/mata_kuliah/delete/'.$row->id) ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus Mata Kuliah ?')"><i class="fa fa-trash"></i></a>
            </td>
          </tr>
