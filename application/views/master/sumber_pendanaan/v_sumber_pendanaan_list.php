      ...
      <div class="col-lg-12">
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Sumber Pendanaan</h3>
          ...
          <tr>
            ...
            <?php
              ...
              ?>
              <a href="<?= site_url('master/sumber_pendanaan/delete/'.$row->id) ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus Sumber Pendanaan ?')"><i class="fa fa-trash"></i></a>
            </td>
          </tr>
