...
<div class="box-body big">
    <?php echo form_open('',array('name'=>'faddmenugrup','class'=>'form-horizontal','role'=>'form'));?>
        ...
        <div class="form-group">
                ...
                <div class="col-sm-8">
                  <?php echo form_dropdown('status_pinjam',$status_pinjam,set_value('id'),'id="status_pinjam" class="form-control select2"');?>
        ...
        <div class="form-group">
            ...
            <?php
            echo button('send_form(document.faddmenugrup,"peminjaman/peminjaman_lab/show_addForm/","#divsubcontent")','Save','btn btn-success')." ";
            ?>
            </div>
        </div>
    </form>
