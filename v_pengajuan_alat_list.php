        ...
        <div class="box box-primary">
          <div class="box-header with-border">
            ...
            <?php
              ...
              if ($sesi == '1' || $sesi == '2' || $sesi == '3' || $sesi == '6') {
                echo button('load_silent("pengajuan/pengajuan_alat/form/base","#modal")','Ajukan Alat','btn btn-success');
              } else {
                # code...
              }
              ?>
          ...
          <tr>
            ...
            <?php
              $sesi = from_session('level');
              if ($sesi == '1' || $sesi == '2' || $sesi == '3' || $sesi == '6') {
                echo button('load_silent("pengajuan/pengajuan_alat/form/base1/'.$row->id.'","#modal")','','btn btn-info fa fa-search','data-toggle="tooltip" title="View"');
